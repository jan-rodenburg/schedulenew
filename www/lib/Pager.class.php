...
class Pager {
	...
	var $limit;
	var $tot_records;
	var $print_limit_select = false;
	
	// User modifiable variables
	var $prev_link = '&laquo;';
	var $next_link = '&raquo;';
	// var $limits = array(10, 50, 100, 1000);
	var $limits = array(10000, 50000, 100000); //janr
	var $view_pages = 3;
	var $table_width = '100%';
	...
	*/
	...
	function Pager($tot_records=0, $limit=10000, $page_var='page', $limit_var='limit') {
		// echo ($limit); //jantest
		$this->tot_records = $tot_records;
		// $this->limit = $limit;
		$this->limit = 10000; // janr override
