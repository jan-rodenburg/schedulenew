...
class User {
	...
	*/
	function load_by_id() {
		...
		// janrlogin new fields
		$this->phone_mob		= $data['phone_mob'];
		$this->email2	= $data['email2'];
		$this->osiris_ok_last		= $data['osiris_ok_last'];
		$this->osiris_ok_now		= $data['osiris_ok_now'];
		$this->demerit_text		= $data['demerit_text'];
		$this->demerit_punt		= $data['demerit_punt'];
		$this->last_modify_osiris		= $data['last_modify_osiris'];
		$this->lnotes		= $data['lnotes'];
		$this->croho		= $data['croho'];
		$this->opleiding		= $data['opleiding'];		
		$this->klas		= $data['klas'];
		$this->nonactive		= $data['nonactive'];
		$this->collegejaar_in		= $data['collegejaar_in'];
		$this->instellingstatus		= $data['instellingstatus'];
		$this->leenpermissie		= $data['leenpermissie'];
		$this->mutbyadmin		= $data['mutbyadmin'];
		$this->phone2		= $data['phone2']; // janr phone2
		unset($data);
	}
	...
	*/
	function get_user_data() {
		return array (
				...
				'email2'		=> $this->email2,
				'osiris_ok_last'		=> $this->osiris_ok_last,
				'osiris_ok_now'		=> $this->osiris_ok_now,
				'demerit_text'		=> $this->demerit_text,
				'demerit_punt'		=> $this->demerit_punt,
				'last_modify_osiris'		=> $this->last_modify_osiris,
				'lnotes'					=> $this->lnotes,
				'croho'						=> $this->croho,
				'opleiding'					=> $this->opleiding,
				'klas'						=> $this->klas,
				'nonactive'						=> $this->nonactive,
				'collegejaar_in'		=> $this->collegejaar_in,
				'instellingstatus'		=> $this->instellingstatus,
				'leenpermissie'		=> $this->leenpermissie,
				'mutbyadmin'		=> $this->mutbyadmin,
				'phone2'		=> $this->phone2
	...
	*/
	...
	function get_email() {
		// janr eerst naar tweede mail adres, anders naar osiris mail adres
		//	return $this->email;
		//if ($this->email2) {
		//	return $this->email2;
		//} else {
