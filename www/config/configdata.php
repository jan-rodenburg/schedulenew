...
$conf['app']['allowed_checkout'] = array("","Uitleen 5.22","Tool-o-Theek","Computerwerkplaats NB","Werkplaats Videomontage NB","Loge","Uitleen locker 1","Uitleen locker 2","Uitleen locker 3","Uitleen locker 4","Uitleen locker 5","Uitleen locker 6","Uitleen locker 7","Uitleen locker 8","Uitleen locker 9","Uitleen locker 10","Uitleen locker 11","Uitleen locker 12","Uitleen locker 13","Uitleen locker 14","Uitleen locker 15","Uitleen locker 16","Uitleen locker 17","Uitleen locker 18","Uitleen locker 19","Uitleen locker 20","Uitleen locker 21","Uitleen locker 22");
$conf['app']['allowed_checkin'] = array("","Uitleen 5.22","Tool-o-Theek","Computerwerkplaats NB","Werkplaats Videomontage NB","Loge","Uitleen locker 1","Uitleen locker 2","Uitleen locker 3","Uitleen locker 4","Uitleen locker 5","Uitleen locker 6","Uitleen locker 7","Uitleen locker 8","Uitleen locker 9","Uitleen locker 10","Uitleen locker 11","Uitleen locker 12","Uitleen locker 13","Uitleen locker 14","Uitleen locker 15","Uitleen locker 16","Uitleen locker 17","Uitleen locker 18","Uitleen locker 19","Uitleen locker 20","Uitleen locker 21","Uitleen locker 22");
...
$conf['loge@rietveldacademie.nl']['adres']= 'Gerrit Rietveld Academie<br />
Loge<br />
Fred Roeskestraat 96<br />
AMSTERDAM<br />
020 5711 600<br />';

$conf['schedulenew@larka.nl']['adres']= 'Gerrit Rietveld Academie<br />
Uitleen 5.22<br />
Fred Roeskestraat 96<br />
AMSTERDAM<br />
020 5711 659<br />';

$conf['uitleen@rietveldwerkplaats.nl']['adres']= 'Gerrit Rietveld Academie<br />
Photography Department<br />
Fred Roeskestraat 96<br />
AMSTERDAM<br />
020 5711 627<br />';

$conf['christiaan@rietvelddigital.nl']['adres']= 'Gerrit Rietveld Academie<br />
...
<tr><td class="cellColor1 w50" colspan="2"><br>Gerrit Rietveld Academie &nbsp;&middot;&nbsp; Uitleen 5.22<br>
...
$thepath = $conf['app']['weburi'];
$docpath = $thepath.'/docs/';

$conf['schedulenew@larka.nl']['linkcontract1']= "<a  href=".$docpath."Voorwaarden-Uitleen-Contract1.pdf>Voorwaarden-Uitleen-Contract1.pdf</a>";
$conf['schedulenew@larka.nl']['linkcontract2']= "<a href=".$docpath."Voorwaarden-Uitleen-Contract1.pdf>Voorwaarden-Uitleen-Contract1.pdf</a>";

$conf['uitleen@rietveldwerkplaats.nl']['linkcontract1']= "<a  href=".$docpath."Voorwaarden-Uitleen-Contract1.pdf>Voorwaarden-Uitleen-Contract1.pdf</a>";
$conf['uitleen@rietveldwerkplaats.nl']['linkcontract2']= "<a href=".$docpath."Voorwaarden-Uitleen-Contract1.pdf>Voorwaarden-Uitleen-Contract1.pdf</a>";

$conf['christiaan@rietvelddigital.nl']['linkcontract1']= "<a  href=".$docpath."Voorwaarden-Uitleen-Contract1.pdf>Voorwaarden-Uitleen-Contract1.pdf</a>";
$conf['christiaan@rietvelddigital.nl']['linkcontract2']= "<a href=".$docpath."Voorwaarden-Uitleen-Contract1.pdf>Voorwaarden-Uitleen-Contract1.pdf</a>";

$conf['toolotheek@rietveldacademie.nl']['linkcontract1']= "<a href=".$docpath."contract-Tool-o-Theek-1.pdf>contract-Tool-o-Theek-1.pdf</a>";
$conf['toolotheek@rietveldacademie.nl']['linkcontract2']= "<a href=".$docpath."contract-Tool-o-Theek-2.pdf>contract-Tool-o-Theek-2.pdf</a>";

$conf['toolotheek@rietveldacademie.nl']['linkcontract1here']= "<a href=".$docpath."contract-Tool-o-Theek-1.pdf>here.</a>";
$conf['toolotheek@rietveldacademie.nl']['linkcontract2here']= "<a href=".$docpath."contract-Tool-o-Theek-2.pdf>here.</a>";


$conf['loge@rietveldacademie.nl']['linkcontract1']= "<a href=".$docpath."Algemene-voorwaarden-uitlenen-Loge.pdf>Algemene-voorwaarden-uitlenen-Loge.pdf</a>";
$conf['loge@rietveldacademie.nl']['linkcontract2']= "<a href=".$docpath."Algemene-voorwaarden-uitlenen-Loge.pdf>Algemene-voorwaarden-uitlenen-Loge.pdf</a>";
...
$conf['schedulenew@larka.nl']['schedulename'] = "Uitleen 5.22";
...
// uitleenperiode, deze verhuist later naar de database (zodat uitleen@rietveldwerkplaats.nl kan editten)
// $conf['uitleen@rietveldwerkplaats.nl']['uitleenperiode']=
//if exists
$conf['uitleenperiode']=1; 						//module uitleenperiode = up  =true
$conf['toolotheek@rietveldacademie.nl']['up']	=0;		//module deze werkplaats ON or OFF
$conf['schedulenew@larka.nl']['up']		=1;		//deze werkplaats ON or OFF
$conf['christiaan@rietvelddigital.nl']['up']	=0;		//deze werkplaats ON or OFF
$conf['uitleen@rietveldwerkplaats.nl']['up']	=1;		//module uitleen@rietveldwerkplaats.nl voor =true
$conf['loge@rietveldacademie.nl']['up']			=0;		//deze werkplaats ON or OFF

																		// $conf['uitleen@rietveldwerkplaats.nl']
//dagdeel, gaat over uren, deze tijden moeten kloppen met schedule hours
$conf['uitleen@rietveldwerkplaats.nl'][1]['uit'][] = array (0 => 20,1 => 16,2 => 12); 	
$conf['uitleen@rietveldwerkplaats.nl'][1]['in'][]  = array (0 => 21,1 => 17,2 => 13); 	
//de check loopt door array UIT (foreach)...
// als starttijd <= 20 dan positive
// als starttijd <= 16 dan positive
// als starttijd <= 12 dan positive.
// JARO: INLEVERDEFAULT:de last positive kiest zelfde index value uit array IN. 
																																												
//weekdeel, gaat over dagen
// julianday mon=0, tue=1 etc.
// 2=Tue and 5=friday, gebruikt fie 'next tuesday', zie reservation.class r 1800
//$conf['uitleen@rietveldwerkplaats.nl'][2]['dag'][]= array (0 => 2,1 => 5);; // = 2=Tue and 5=friday, NIET GEBRUIKT
$conf['uitleen@rietveldwerkplaats.nl'][2]['uit'][]= array (0 => 20,1 => 16,2 => 12);
$conf['uitleen@rietveldwerkplaats.nl'][2]['in'][] = array (0 => 21,1 => 17,2 => 13);

// 3
// week, gebruikt $conf['uitleen@rietveldwerkplaats.nl'][2]
// doet +seven days

																		// $conf['schedulenew@larka.nl']
// 1
// nextday
...
$conf['schedulenew@larka.nl'][1]['in'] = 13; // 13 uur
/// 1.2.9 ///
$conf['ldap']['ssl'] = false;
/// END 1.2.9 ///
?>