...
$conf['debug'] = '1'; // debug = on local, show webmaster test box
...
$conf['db']['dbUser'] = 'grauitleendev';
$conf['db']['dbPass'] = 'Pea0weDo';


// Prefix to attach to all table names []
$conf['db']['tbl_prefix'] = 'db01_';
$conf['app']['weburi'] = '//uitleen.rietveldacademie.nl/schedulenew';
//$conf['app']['weburi'] = '//localhost:7777/schedule/www';
/**
