...
// showQuickLinks(Auth::isAdmin(), $is_group_admin, Auth::isScheduleAdmin());		// Print out My Quick Links, verhuisd naar template class

startDataDisplayCol();

if (Auth::isAdmin() || Auth::isScheduleAdmin()) { //test
	$admin = new Admin('resources');
	$admin->searchResourcesTable();
} else {
