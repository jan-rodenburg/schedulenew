...
if ($res->has_errors()) {
	...
	echo '<table align="center" width="100%" cellspacing="0" cellpadding="1"><tr class="messagePositive"><td width="25"><img src="img/checkbox.gif" alt="ok"/></td><td>' . 'mo' . '</td></tr></table>';
}
// debug janr
// var_dump($res);
