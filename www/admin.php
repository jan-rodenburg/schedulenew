...
//include_once('templates/1811tip_admin.template.php');
//include_once('templates/1800tip_help_temp.php');
//include_once('templates/1800tip_help_temp.my.php');
//include_once('templates/1800tip_help_temp.res.php');
...
if (!Auth::isAdmin()) {
    CmnFns::do_error_box('29'.translate('This is only accessable to the administrator') . '<br />'
