    ...
    <form name="searchForm" method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
      <table width="100%" border="0" cellspacing="0" cellpadding="1" align="center">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td colspan="2" class="tableTitle">&middot; <?php echo translate('Select Search Criteria')?></td>
          </tr>
		  <tr class="cellColor">
	...
	switch ($type) {
			case 'html' :
				...
				echo '<tr class="cellColor" align="center" style="font-weight: normal;">'
					...
					. '<td>' . $starttime . "</td>\n"
					. '<td>' . $endtime . "</td>\n"
					. '<td>' . $link->getLink("javascript: reserve('m','','','" . $resid. "');", translate('IconEdit'), '', '', translate('Edit this reservation')) . "</td>\n"
					. '<td>' . $totTime . "</td>\n</tr>\n";
				break;
        	case 'text' :
