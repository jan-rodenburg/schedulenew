...
<h3 align="xenter">made by larka :: based on phpScheduleIt v<?php echo $conf['app']['version']?></h3>
<?php
}
...
function doPrintForm() {
	global $conf;
?>
<h3 align="xenter"><?php echo translate('Please log into your database')?></h3>
