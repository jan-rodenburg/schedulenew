...
/**
* janr
* based on check-child.php, check.php. 
* check to see if ALL resources inthis cluster are available, when new enddate and time is given. - no check accesoiries, no check repeat_dates -
*
...
* not: The output from this is to be used by an AJAX response handler
* The output from this is sent to Div in screen: <div id="Verleng'.$resid.'">
