...
include_once('config/configdata.php');
...
<head>
<title>uitleen <?php echo translate('Help')?></title>
...
if (Auth::isAdmin()) {
	$help_file = 'lang/nl.admin.help.php'; //admin help, deze dus
}else{
	$help_file = 'lang/' . $languages[$lang][2] . '.help.php'; // user: kan verschillende taal zijn
}
echo ($help_file);
