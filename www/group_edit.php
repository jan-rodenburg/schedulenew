...
if (!isset($_POST['submit'])) {
	...
	if ( !Auth::isAdmin() && !$cur_user->is_group_admin($user->get_groupids()) ) {
		CmnFns::do_error_box(translate('290'.'This is only accessable to the administrator'));
		die();
	}
	...
	if ( !Auth::isAdmin() ) {
		CmnFns::do_error_box(translate('37'.'This is only accessable to the administrator'));
		die();
	}
